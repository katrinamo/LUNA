...
var CreateAccountPage = (function () {
    function CreateAccountPage(navCtrl, navParams, alertCtrl, http, storage) {
        var _this = this;
    ...
    CreateAccountPage.prototype.check_EmailID = function (emailID, usernameHash, passwordHash) {
        var _this = this;
    ...
    CreateAccountPage.prototype.customalert = function (s, t) {
        console.log("alert: " + s);
